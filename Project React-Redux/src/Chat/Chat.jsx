        ...
        return (
            <div className={this.props.showChatHendler ? "showChat" : "hideChat"}>
                <div className="usName">
                    ...
                    <i className="fas fa-home icon-reg" title="registration" onClick={this.props.registration} id='registrationShow'></i>
                    <i className="fas fa-sign-in-alt icon-log" title="login" onClick={this.props.login} id='loginShow'></i>
                </div>
